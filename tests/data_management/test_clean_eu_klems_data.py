...
from tests.data_management.mocks.mock import (
    EU_KLEMS_FIXTURE_PATH,
    MOCK_YEARS_RANGE,
    mock_eu_klems_data,
    save_mock_eu_klems_data,
)
...
def growth_accounts(data_info):
    return clean_eu_klems_data.read_growth_accounts(
        data_info=data_info,
...
def test_clean_and_reshape_eu_klems_return_type(
    capital_accounts,
    data_info,
    years_range,
):
...
def test_clean_and_reshape_eu_klems_categorical_columns(
    capital_accounts,
    data_info,
    years_range,
):
...
def test_clean_and_reshape_eu_klems_variable_type(
    capital_accounts,
    national_accounts,
    growth_accounts,
    data_info,
    ...
    capital_accounts_variables = data_info["sheets_to_read"][
