...
def _get_base_gdp_data():
    """Generate data for basic columns in the mock GDP data set. Series Name, Series
    Code, Country Code, Country Name. The data is junk, except for Country Code and
    Country Name, which are real and use countries from the project.
