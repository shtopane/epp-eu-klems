...
labour_productivity_composition_deps = {
  ...
  "growth_accounts": get_account_data_path_for_countries("growth", ALL_COUNTRY_CODES_LESS_SK)
}
...
for years in labour_productivity_composition_year_ranges:
    ...
    def task_labour_productivity_composition(
        ...
        path_to_labour_productivity_composition: Annotated[Path, Product] = BLD_PYTHON / "labour_productivity" / f"composition_{years.start}_{years.stop - 1}.pkl"
    ):
