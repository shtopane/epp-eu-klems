...
labor_productivity_composition_deps = {
...
def task_labor_productivity_composition(
    depends_on=labor_productivity_composition_deps,
    path_to_labor_productivity_composition: Annotated[Path, Product] = BLD_PYTHON / "labor_productivity" / "composition.pkl"
):
    """Calculate the composition of labor productivity growth for each country.
    For each country, select the growth accounts data for the years 1995 to 2006 and calculate the composition of labor productivity growth.
    ...
    pd.to_pickle(labour_productivity_growth_composition, path_to_labor_productivity_composition)