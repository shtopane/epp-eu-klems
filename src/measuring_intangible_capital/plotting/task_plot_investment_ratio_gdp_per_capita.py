...
plot_investment_ratio_gdp_per_capita_deps = {
  ...
  "tangible_investment": BLD_PYTHON / "share_tangible" / "gdp_aggregate_2000_2004.pkl",
...
def task_plot_investment_ratio_gdp_per_capita(
  ...
  """"Figure 5b: Plot the ratio between intangible and tangible investment and GDP per capita for all years and countries."""
